    ...
    <div className="container">
        <div className="row my-5">
            ...
            <div className="col-6 align-self-center">
                <div class="sectionsHeading text-right">
                ...
                <div className="chefCardDeck my-5">   
                    ...
                    <div className="chefChoiceCardWrapper">
                        <div className="recipeImgWrapper">
                            ...
                            <div className="membersLogo"><img src="./assets/chef-stamp@2x.png" title="members logo" className="membersLogo" alt="members logo"/></div>
                            <img src="./assets/img/rosted_pizza.jpg" title="recipe photo" alt="recipe photo" className="recipePhoto"/>
                            <div className="recipeAction"><img src="./assets/go-btn@2x.png" title="right arrow btn" className="recipeActionBtn" alt="right arrow btn"/></div>
                        </div>
